	...
	* {
    ...
    <body>
        ...
        <?php
			...
			<tr>
			 <th>CHESTIONARUL 1</th>
			 <th>CHESTIONARUL 2</th>
			</tr>';
			for ($i=0; $i <$num_results; $i++)
			{
				$row = mysqli_fetch_assoc($result);
				echo '<tr><td>'.stripslashes($row['Idc 1']).'</td>';
				echo '<td>'.stripslashes($row['Idc 2']).'</td>';
			}
			echo '</table>';
...
<button class="NEXT"
	onclick="window.location.href = 'http://127.0.0.1/examen_auto/r5a.php';">Next
	</button>
</p>
</html>