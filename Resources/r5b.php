	...
	* {
    ...
    <body>
        ...
        echo '<p style="color:white;text-align:center;color: rgba(180,190,240,1); font-size:200%">Nu exista acest test!</p>';
			...
			echo '<Table style = "width:10%;margin-left: auto; margin-right: auto;">
			<tr>
			 <th>TESTUL</th>
			</tr>';
...
<button class="NEXT"
	onclick="window.location.href = 'http://127.0.0.1/examen_auto/r6a.php';">Next	
	</button>
</p>
</html>