	...
	* {
    ...
    <body>
        ...
        <?php
			...
			if ($num_results <= 0) {
        echo '<p style="color:white;text-align:center;color: rgba(180,190,240,1); font-size:200%">Nu exista acest test!</p>';
    } 
	else{
            // se afişează fiecare tuplă returnată
			echo '<Table style = "width:12%;margin-left: auto; margin-right: auto;">
			<tr>
			 <th>INTREBAREA</th>
			</tr>';
			for ($i=0; $i <$num_results; $i++)
			{
				...
				echo '<tr><td>'.stripslashes($row['id_i']).'</td>';
			}
			echo '</table>';
	}
...
<button class="NEXT"
	onclick="window.location.href = 'http://127.0.0.1/examen_auto/afisare_web.html';">Next	
	</button>
</p>
</html>